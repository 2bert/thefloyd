...
// Check if controller has a callable method in the controller class, if then call it
  ...
  public function ThemeEngineRender() {
    ...
    $themePath  = FLOYD_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = FLOYD_INSTALL_PATH . '/' . $this->config['theme']['parent'];
      $parentUrl  = $this->request->base_url . $this->config['theme']['parent'];
    }
    
    // Add stylesheet name to the $fl->data array
    $this->data['stylesheet'] = $this->config['theme']['stylesheet'];
    
    // Make the theme urls available as part of $fl
    ...
    $fl = &$this;
    // First the default Floyd themes/functions.php
  ...
  public function AddMessage($type, $message, $alternative=null) {
    ...
    /**
   * Draw HTML for a menu defined in $fl->config['menus'].
   *
