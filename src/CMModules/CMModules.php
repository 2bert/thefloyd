<?php
/**
 * A model for managing Floyd modules.
 * 
 * @package FloydCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $floydCoreModules = array('CFloyd', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $floydCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isFloydCore']   = in_array($rc->name, $this->floydCoreModules);
      $details['isFloydCMF']    = in_array($rc->name, $this->floydCMFModules);
